...
export default function CreateListing() {
    ...
    //cannot give asynchronous directly
    useEffect(() => {
    ...
    const handleImageSubmit = (e) => {
        ...
        {
            setImageUploadError('Add atleast 1 image to upload.');
            setUploading(false);
        }
        else{
            setImageUploadError('You can only add 6 images per listing.');
            setUploading(false);
        }
    };
...
const handleSubmit = async (e) => {
    e.preventDefault();
    try {
        if(formData.imageUrls.length <1) return setError('Add atleast 1 image to in order to create listing.');
    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <div className='flex flex-col gap-4 flex-1'>
            ...
            <div className='flex flex-wrap gap-6'>
                ...
                <div className='flex items-center gap-2'>
                    <input className='p-3 border border-gray-300 rounded-lg' type="number" id="regularPrice" min="1000" max="100000" required onChange={handleChange} value={formData.regularPrice}/>
                    ...
                    {formData.offer && (
                      <div className='flex items-center gap-2'>
                      <input className='p-3 border border-gray-300 rounded-lg' type="number" id="discountPrice" min="0" max="100000" required onChange={handleChange} value={formData.discountPrice}/>
                      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col flex-1 gap-4">
            ...
            <div className="flex gap-4">
                ...
                <button disabled={uploading} type='button' onClick={handleImageSubmit} className='p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opaciity-80'>{uploading ? 'Uploading...':'Upload'}</button>
                </div>
